...
LABEL description="image for rasdaman container with Ubuntu 20.04"
...
RUN apt-get -y update --fix-missing && \
    ...
    echo "deb [arch=amd64] http://download.rasdaman.org/packages/deb focal testing" | tee /etc/apt/sources.list.d/rasdaman.list && \
